...
UI_text::UI_text(const SDL_Rect& dst, const char* texture_id, const char* font_id, const char* text, TextureManager* texture_manager) : GameObject(SDL_Rect{ 0,0,0,0 }, dst, texture_id), font_id(font_id), current_text(text), textures(texture_manager)
{
