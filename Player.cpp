...
Player::Player(bool is_human, std::vector<Card*>::iterator first_card, std::vector<Card*>::iterator last_card, TextureManager* textur_manager, GLBL::player_side side, int hp, int mp, int gold) : is_human(is_human), textur_manager(textur_manager), side(side), health(hp), mana(mp), gold(gold)
{
